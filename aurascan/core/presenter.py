...
EXACT_TEMPLATES: Dict[str, Dict[str, str]] = {
    ...
    'INTELLIGENCE-UNAVAILABLE-001': {
        'title': 'Runtime intelligence inspection did not complete.',
        'summary': 'Protected intelligence storage could not provide a verified stable generation.',
        'why': 'Missing coverage cannot establish that current known malicious indicators were checked.',
        'checked': 'AuraScan checked local generation metadata, ownership and integrity without contacting an update service.',
        'not_prove': 'This does not identify malware, prove tampering by an attacker or establish host compromise.',
        'action': 'Restore a verified intelligence bundle and rescan before accepting this operation.',
    },
    'SUPPLYCHAIN-NPM-MALICIOUS-RELEASE-001': {
        'title': 'An observed malicious npm release is selected.',
        'summary': 'A supported installation argument or decoded package field selects an exact reviewed malicious package/version tuple.',
        'why': 'Package installation can invoke attacker-controlled lifecycle scripts; registry availability cannot clear the match.',
        'checked': 'AuraScan compared captured identity fields with one reviewed intelligence snapshot without installing dependencies.',
        'not_prove': 'Selection does not prove installation, execution, propagation or host compromise.',
        'action': 'Do not build this revision; review the cited package provenance and any independent execution evidence.',
    },
    'SUPPLYCHAIN-NPM-ADVISORY-REVIEW-001': {
        'title': 'An npm malware-advisory package needs version review.',
        'summary': 'The selected package has an explicitly reviewed all-version malware advisory; the selector does not match an exact observed release.',
        'why': 'A different version or unresolved selector cannot establish a patched release under this advisory.',
        'checked': 'AuraScan compared captured selectors with the reviewed advisory scope; it did not resolve registry tags.',
        'not_prove': 'This does not identify the selected bytes or establish installation, execution or host compromise.',
        'action': 'Review the precise dependency provenance and advisory scope before accepting the build.',
    },
    'SUPPLYCHAIN-NPM-MALICIOUS-DESTINATION-001': {
        'title': 'A static network target matches reviewed malicious infrastructure.',
        'summary': 'A supported active network command targets an exact reviewed malicious hostname.',
        'why': 'A confirmed malicious destination is adverse evidence independent of registry availability or package signatures.',
        'checked': 'AuraScan parsed the literal command destination without making a network request.',
        'not_prove': 'This does not prove successful contact, data transfer, execution or host compromise.',
        'action': 'Do not run this build; review the control path and independently established execution evidence.',
    },
    'DEEPSTATIC-NPM-MALICIOUS-RELEASE-001': {
        'title': 'An observed malicious npm release is selected.',
        'summary': 'A supported installation argument or decoded package field selects an exact reviewed malicious package/version tuple.',
        'why': 'Package installation can invoke attacker-controlled lifecycle scripts; registry availability cannot clear the match.',
        'checked': 'AuraScan compared captured identity fields with one reviewed intelligence snapshot without installing dependencies.',
    ...
    'DEEPSTATIC-NPM-ADVISORY-REVIEW-001': {
        'title': 'An npm malware-advisory package needs version review.',
        'summary': 'The selected package has an explicitly reviewed all-version malware advisory; the selector does not match an exact observed release.',
        'why': 'A different version or unresolved selector cannot establish a patched release under this advisory.',
        'checked': 'AuraScan compared captured selectors with the reviewed advisory scope; it did not resolve registry tags.',
    ...
    'DEEPSTATIC-NPM-MALICIOUS-DESTINATION-001': {
        'title': 'A static network target matches reviewed malicious infrastructure.',
        'summary': 'A supported active network command targets an exact reviewed malicious hostname.',
        'why': 'A confirmed malicious destination is adverse evidence independent of registry availability or package signatures.',
        'checked': 'AuraScan parsed the literal command destination without making a network request.',
    ...
    'DEEPSTATIC-NPM-MALICIOUS-PAYLOAD-001': {
        'title': 'Captured source bytes match a reviewed malicious payload.',
        'summary': 'A stable captured source file has the exact SHA-256 recorded for a reviewed malicious payload.',
        'why': 'An exact malicious file hash remains adverse evidence regardless of filename, metadata, signatures or registry availability.',
        'checked': 'AuraScan hashed bounded no-follow source bytes without executing, importing or decoding the payload.',
        'not_prove': 'File presence does not prove execution, persistence, propagation or host compromise.',
        'action': 'Do not build or execute this source; preserve evidence and review any independently established execution.',
    },
    'SUPPLYCHAIN-NPM-SHAIHULUD-20260907': {
        ...
        'checked': 'AuraScan compared captured control text or metadata with reviewed, referenced campaign intelligence without installing dependencies.',
