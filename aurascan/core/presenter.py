...
EXACT_TEMPLATES: Dict[str, Dict[str, str]] = {
    ...
    "NPM-METADATA-INSPECTION-INCOMPLETE-001": {
        ...
        "summary": "A package manifest or pnpm lockfile has malformed, ambiguous, unsupported, or over-limit metadata.",
        "why": "Accepting metadata after silently skipping unsupported name fields could hide a path-escape input.",
        "checked": "AuraScan used strict JSON and a bounded literal pnpm YAML subset, rejecting duplicate keys, object construction, aliases, and unsupported dependency identities.",
