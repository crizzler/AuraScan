...
RULE_METADATA: Dict[str, RuleMetadata] = {
    ...
    "DEEPSTATIC-NPM-SHAIHULUD-REVIEW-001": RuleMetadata("DEEPSTATIC-NPM-SHAIHULUD-REVIEW-001", RuleCategory.history_supply_chain, Severity.HIGH, "npm-shai-hulud-review", 95, True, "deterministic", "Acquired npm metadata selects a malware-advisory package whose exact campaign version is unresolved."),
    "DEEPSTATIC-NPM-SHAIHULUD-PAYLOAD-001": RuleMetadata("DEEPSTATIC-NPM-SHAIHULUD-PAYLOAD-001", RuleCategory.history_supply_chain, Severity.CRITICAL, "npm-shai-hulud-payload", 95, True, "deterministic", "Stable captured source bytes match the verified Shai-Hulud payload SHA-256."),
    "SUPPLYCHAIN-NPM-SHAIHULUD-C2-001": RuleMetadata("SUPPLYCHAIN-NPM-SHAIHULUD-C2-001", RuleCategory.network_behavior, Severity.CRITICAL, "npm-shai-hulud-c2", 95, True, "deterministic", "A package control command targets the exact confirmed campaign C2 hostname."),
    "DEEPSTATIC-NPM-SHAIHULUD-C2-001": RuleMetadata("DEEPSTATIC-NPM-SHAIHULUD-C2-001", RuleCategory.network_behavior, Severity.CRITICAL, "npm-shai-hulud-c2", 95, True, "deterministic", "An acquired shell command targets the exact confirmed campaign C2 hostname."),
    "SUPPLYCHAIN-NPM-INSPECTION-INCOMPLETE-001": RuleMetadata("SUPPLYCHAIN-NPM-INSPECTION-INCOMPLETE-001", RuleCategory.deterministic_static, Severity.HIGH, "npm-campaign-coverage", 95, True, "deterministic", "Bounded npm command or intelligence inspection did not complete."),
    "NPM-LIFECYCLE-SUPPLYCHAIN-001": RuleMetadata("NPM-LIFECYCLE-SUPPLYCHAIN-001", RuleCategory.history_supply_chain, Severity.CRITICAL, "npm-lifecycle-correlation", 95, True, "deterministic", "A package lifecycle launcher is bound to captured code with correlated supply-chain indicators."),
    "NPM-LIFECYCLE-CREDENTIAL-ACCESS-001": RuleMetadata("NPM-LIFECYCLE-CREDENTIAL-ACCESS-001", RuleCategory.credential_exposure, Severity.HIGH, "npm-lifecycle-credentials", 95, True, "deterministic", "A captured lifecycle entry script contains credential access operations."),
    "NPM-LIFECYCLE-PERSISTENCE-001": RuleMetadata("NPM-LIFECYCLE-PERSISTENCE-001", RuleCategory.persistence, Severity.HIGH, "npm-lifecycle-persistence", 95, True, "deterministic", "A captured lifecycle script correlates agent/editor configuration writes with additional sensitive operations."),
    "NPM-LIFECYCLE-INSPECTION-INCOMPLETE-001": RuleMetadata("NPM-LIFECYCLE-INSPECTION-INCOMPLETE-001", RuleCategory.deterministic_static, Severity.HIGH, "npm-lifecycle-coverage", 95, True, "deterministic", "A supported npm lifecycle entry could not be inspected completely within bounds."),
    ...
    "NPM-METADATA-INSPECTION-INCOMPLETE-001": RuleMetadata("NPM-METADATA-INSPECTION-INCOMPLETE-001", RuleCategory.deterministic_static, Severity.HIGH, "npm-metadata-coverage", 95, True, "deterministic", "Bounded package manifest/npm lock JSON or supported literal pnpm YAML inspection did not complete."),
...
_INSTRUCTION_GUARD_RULES = {
    ...
    "IG-CONFIG-CURSOR-BROAD-GRANT": (Severity.HIGH, "instruction-tool-grant", 90, "Cursor approval settings request broad authority; effective policy and execution are not established."),
    "IG-CONFIG-CURSOR-COMMAND-BEHAVIOR": (Severity.HIGH, "instruction-active-command", 90, "Supported Cursor command fields correlate retrieval with execution or credential-file access with transfer."),
    "IG-CONFIG-CURSOR-AUTOREVIEW-BEHAVIOR": (Severity.HIGH, "instruction-tool-grant", 85, "Cursor Auto-review allow guidance contains correlated sensitive behavior."),
