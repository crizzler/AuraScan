...
RULE_METADATA: Dict[str, RuleMetadata] = {
    ...
    "SOURCE-OFFLINE-UNINSPECTED": RuleMetadata(
        ...
        True,
        None,
        "Offline mode intentionally left a declared remote source uninspected.",
    ),
    "SOURCE-LOCAL-UNSAFE": RuleMetadata(
        "SOURCE-LOCAL-UNSAFE",
        RuleCategory.source_acquisition,
        Severity.HIGH,
        "source-acquisition-incomplete",
        ...
        True,
        None,
        "A local source could not be captured as a safe bounded regular file.",
    ),
    "SOURCE-UNINSPECTED": RuleMetadata(
        "SOURCE-UNINSPECTED",
        RuleCategory.source_acquisition,
        Severity.HIGH,
        "source-acquisition-incomplete",
        ...
        True,
        None,
        "A declared source was not acquired for deep-static inspection.",
    ),
    ...
    "CLAMAV-INCOMPLETE": RuleMetadata(
        "CLAMAV-INCOMPLETE",
        RuleCategory.clamav_signature,
        Severity.HIGH,
        "clamav-scan",
        ...
        True,
        "clamav",
        "ClamAV inspection did not complete within its safety bounds.",
    ),
    ...
    "SUPPLYCHAIN-AUR-REPO-PROPAGATION-001": RuleMetadata("SUPPLYCHAIN-AUR-REPO-PROPAGATION-001", RuleCategory.history_supply_chain, Severity.CRITICAL, "aur-repository-propagation", 100, True, "deterministic", "Correlates an AUR Git remote with repository mutation and a Git push from package code."),
    "AUR-REPO-OPAQUE-ARTIFACT-001": RuleMetadata("AUR-REPO-OPAQUE-ARTIFACT-001", RuleCategory.history_supply_chain, Severity.MEDIUM, "aur-repository-opaque-artifact", 70, True, "deterministic", "Finds an undeclared executable-format or archive artifact present beside a PKGBUILD."),
    "AUR-REPO-OPAQUE-BINARY-001": RuleMetadata("AUR-REPO-OPAQUE-BINARY-001", RuleCategory.history_supply_chain, Severity.HIGH, "aur-repository-opaque-install", 95, True, "deterministic", "Correlates an undeclared opaque repository artifact with a package-image installation request."),
    "AUR-REPO-OPAQUE-BINARY-EXEC-001": RuleMetadata("AUR-REPO-OPAQUE-BINARY-EXEC-001", RuleCategory.history_supply_chain, Severity.CRITICAL, "aur-repository-opaque-execution", 100, True, "deterministic", "Correlates an undeclared opaque repository artifact with an execution, code-loading, or set-user-ID/set-group-ID request."),
    "AUR-REPO-INSPECTION-INCOMPLETE-001": RuleMetadata("AUR-REPO-INSPECTION-INCOMPLETE-001", RuleCategory.deterministic_static, Severity.HIGH, "aur-repository-inspection-incomplete", 100, True, "deterministic", "The bounded package-repository provenance snapshot could not be completed safely."),
    "SUPPLYCHAIN-REMOTE-STAGE-EXEC-001": RuleMetadata("SUPPLYCHAIN-REMOTE-STAGE-EXEC-001", RuleCategory.network_behavior, Severity.CRITICAL, "remote-stage-execution", 100, True, "deterministic", "Correlates a remote download with execution of the acquired or derived artifact."),
    "SUPPLYCHAIN-OPAQUE-CARRIER-EXEC-001": RuleMetadata("SUPPLYCHAIN-OPAQUE-CARRIER-EXEC-001", RuleCategory.deterministic_static, Severity.CRITICAL, "opaque-carrier-execution", 100, True, "deterministic", "Correlates local decoding with execution of the derived artifact or detects execution through a media, document, or font filename."),
    "STATIC-REMOTE-STAGE-INSPECTION-INCOMPLETE-001": RuleMetadata("STATIC-REMOTE-STAGE-INSPECTION-INCOMPLETE-001", RuleCategory.deterministic_static, Severity.HIGH, "remote-stage-inspection-incomplete", 100, True, "deterministic", "Bounded package-text parsing did not complete while checking remote-stage execution."),
    "DEEPSTATIC-REMOTE-STAGE-EXEC-001": RuleMetadata("DEEPSTATIC-REMOTE-STAGE-EXEC-001", RuleCategory.network_behavior, Severity.CRITICAL, "remote-stage-execution", 100, True, "deterministic", "Finds a remote second-stage execution chain in acquired source text."),
    "DEEPSTATIC-OPAQUE-CARRIER-EXEC-001": RuleMetadata("DEEPSTATIC-OPAQUE-CARRIER-EXEC-001", RuleCategory.deterministic_static, Severity.CRITICAL, "opaque-carrier-execution", 100, True, "deterministic", "Finds local decoded-artifact execution or code invocation through a media, document, or font filename in acquired source text."),
    "DEEPSTATIC-INSPECTION-INCOMPLETE-001": RuleMetadata("DEEPSTATIC-INSPECTION-INCOMPLETE-001", RuleCategory.source_acquisition, Severity.HIGH, "deepstatic-inspection-incomplete", 95, True, "deterministic", "Bounded acquired-source traversal or candidate reading did not complete safely."),
    "DEEPSTATIC-NESTED-ARCHIVE-UNINSPECTED-001": RuleMetadata("DEEPSTATIC-NESTED-ARCHIVE-UNINSPECTED-001", RuleCategory.archive_safety, Severity.HIGH, "deepstatic-inspection-incomplete", 95, True, "deterministic", "A nested source archive was not recursively inspected."),
    ...
    "ARCHIVE-UNSUPPORTED": RuleMetadata("ARCHIVE-UNSUPPORTED", RuleCategory.archive_safety, Severity.HIGH, "archive-inspection-incomplete", 90, True, None, "Declared source content could not be inspected as a supported archive."),
    "ARCHIVE-INPUT-UNSAFE": RuleMetadata("ARCHIVE-INPUT-UNSAFE", RuleCategory.archive_safety, Severity.HIGH, "archive-inspection-incomplete", 95, True, None, "Archive input could not be bound to an unchanged regular-file snapshot."),
    "ARCHIVE-EXTRACTION-FAILED": RuleMetadata("ARCHIVE-EXTRACTION-FAILED", RuleCategory.archive_safety, Severity.HIGH, "archive-inspection-incomplete", 95, True, None, "Archive extraction failed before every entry could be inspected."),
    "ARCHIVE-SPECIAL-FILE": RuleMetadata("ARCHIVE-SPECIAL-FILE", RuleCategory.archive_safety, Severity.HIGH, "archive-special-entry", 95, True, None, "Archive contains a special or unsupported entry type."),
    "ARCHIVE-LINK-UNINSPECTED": RuleMetadata("ARCHIVE-LINK-UNINSPECTED", RuleCategory.archive_safety, Severity.HIGH, "archive-inspection-incomplete", 90, True, None, "Archive link behavior was not materialized for static inspection."),
