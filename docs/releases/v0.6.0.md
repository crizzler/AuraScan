...
Release notes for the AI-Assisted Recovery Environment. The release artifact
section is finalized only after the exact hybrid image passes firmware,
credential, and recovery-flow validation.
